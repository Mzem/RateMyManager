...
import fr.aymax.authService.config.AppConfig;
import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.SignatureAlgorithm;

/**
 * This class provides a method to create a JWT (createToken) and a method to parse and validate a JWT and to return an Authentication object (getAuthentication).
 */
@Component
public class TokenProvider 
{
	...
	/**
	 * This method receives the JWT and parses it. The code needs to set the same secret key as in the token creation method to check the validity of the signature. 
