...
export class MyApp 
{
	...
	constructor(platform: Platform, statusBar: StatusBar, private splashScreen: SplashScreen, private menuCtrl: MenuController, private authProvider: AuthProvider, public events: Events) 
	{
		platform.ready().then(() => {
